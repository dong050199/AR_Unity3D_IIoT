...
public class SensorReader : MonoBehaviour
{
    ...
    void UpdateComponent()
    {
        ...
        gameObject.GetComponent<Dashboard>().flowspVal = sensorData.flowsp;
        gameObject.GetComponent<Dashboard>().flowpvVal = sensorData.flowpv;
        gameObject.GetComponent<Dashboard>().p3timeVal = sensorData.p3;
        gameObject.GetComponent<Dashboard>().valveVal = sensorData.val;
        gameObject.GetComponent<Dashboard>().sensorVal = sensorData.sen;
